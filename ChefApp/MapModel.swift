...
init() {
    // Defualt Info
    self.region = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 24.713552, longitude: 46.675297), span: MKCoordinateSpan(latitudeDelta: 5, longitudeDelta: 5))
    
    self.locations.insert(Locationa(name: "Pin", coordinate: CLLocationCoordinate2D(latitude: 24.713552, longitude: 46.675297)), at: 0)
}
